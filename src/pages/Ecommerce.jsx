				...
				<div className="grid grid-cols-4 gap-4">
					<div className="bg-white dark:text-gray-200 dark:bg-secondary-dark-bg md:w-56 rounded-2xl ">
						...
						<div class="flex flex-wrap mx-2 my-1">
							<h1 class="flex-auto text-lg font-semibold text-slate-400">Title</h1>
							<div class="text-lg font-semibold text-slate-500">$110.00</div>
						</div>
						<button class="rounded-full m-2 px-3 py-1 bg-red-700">approve</button>
					...
					<div className="bg-white dark:text-gray-200 dark:bg-secondary-dark-bg md:w-56 rounded-2xl ">
						...
						<div class="flex flex-wrap ml-2 mr-2">
							<h1 class="flex-auto text-lg font-semibold text-slate-900">Classic</h1>
							<div class="text-lg font-semibold text-slate-500">$110.00</div>
						</div>
					</div>
				</div>
